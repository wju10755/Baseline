        ...
        if (Test-Path 'C:\Program Files (x86)\SonicWall\SSL-VPN\NetExtender\NECLI.exe') {
            ...
            if ($connectionProfile) {
                ...
                try {
                    ...
                    Start-Process -FilePath "cmd.exe" -ArgumentList "/c $djoinCommand" -Credential $cred -Wait
                    ...
                    Start-Process -FilePath "cmd.exe" -ArgumentList "/c $djoinRequestCommand" -Credential $cred -Wait
